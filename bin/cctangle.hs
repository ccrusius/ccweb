...
{-# LINE 84 "org/tangle.org" #-}
  show (LinePragma _ _) = []
{-# LINE 133 "org/tangle.org" #-}
type Indent = String
{-# LINE 144 "org/tangle.org" #-}
